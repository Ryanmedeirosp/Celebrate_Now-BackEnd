...
VALUES 
('12345-678', 'SP', 'São Paulo', 'Centro', 'Rua das Flores', '123'),
('87654-321', 'RJ', 'Rio de Janeiro', 'Copacabana', 'Avenida Atlântica', '456'),
('45678-123', 'MG', 'Belo Horizonte', 'Savassi', 'Rua Pernambuco', '789'),
('65432-987', 'BA', 'Salvador', 'Pelourinho', 'Ladeira do Carmo', '321');

-- Populando a tabela ceremonialist
INSERT INTO ceremonialist (name, email, password, document, birthday, phone, id_address)
VALUES 
('Ana Paula', 'ana.paula@email.com', 'senha123', '12345678901234', '1990-05-15', '(11) 91234-5678', 1),
('Carlos Silva', 'carlos.silva@email.com', 'senha456', '56789012345678', '1985-09-25', '(21) 97654-3210', 2);

-- Populando a tabela client
INSERT INTO client (name, email, password, cpf, birthday, phone, id_cerimonialist, id_address)
VALUES 
('Mariana Souza', 'mariana.souza@email.com', 'cliente123', '12345678901', '1995-07-20', '(31) 98877-6655', 1, 3),
('João Pedro', 'joao.pedro@email.com', 'cliente456', '98765432100', '1992-11-10', '(11) 99988-7766', 2, 4);
...
VALUES 
('Buffet Delícia', 'contato@buffetdelicia.com', '12345678000199', '(11) 90000-1234', 'Buffet', 'Serviço completo de buffet para eventos.', 1, 1),
('Decoração & Cia', 'contato@decoracaocia.com', '98765432000188', '(21) 95555-4321', 'Decoração', 'Decoração personalizada para casamentos.', 2, 2);
